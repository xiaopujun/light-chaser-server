...
import lightchaser.data.provider.calcite.dialect.SqlStdOperatorSupport;
import lightchaser.data.provider.jdbc.adapters.JdbcDataProviderAdapter;
...
public class JdbcDataProvider extends DataProvider {
    ...
    public static final String DEFAULT_ADAPTER = "lightchaser.data.provider.jdbc.JdbcDataProvider";
